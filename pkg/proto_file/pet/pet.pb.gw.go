...
var (
	filter_PetStore_GetAllPet_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func local_request_PetStore_GetAllPet_0(ctx context.Context, marshaler runtime.Marshaler, server PetStoreServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetAllPetRequest
	var metadata runtime.ServerMetadata
...
func RegisterPetStoreHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PetStoreServer) error {
	...
	mux.Handle("GET", pattern_PetStore_GetAllPet_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_PetStore_GetAllPet_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_PetStore_GetAllPet_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterPetStoreHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PetStoreClient) error {
	...
	mux.Handle("GET", pattern_PetStore_GetAllPet_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_PetStore_GetAllPet_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	forward_PetStore_GetAllPet_0 = runtime.ForwardResponseMessage
)
