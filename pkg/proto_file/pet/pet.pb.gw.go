...
func RegisterPetStoreHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PetStoreServer) error {
	...
	mux.Handle("GET", pattern_PetStore_GetPets_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/pet.v1.PetStore/GetPets", runtime.WithHTTPPathPattern("/pet/v1/getall/{limit}/{offset}"))
		if err != nil {
...
func RegisterPetStoreHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PetStoreClient) error {
	...
	mux.Handle("GET", pattern_PetStore_GetPets_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/pet.v1.PetStore/GetPets", runtime.WithHTTPPathPattern("/pet/v1/getall/{limit}/{offset}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_PetStore_GetPets_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4}, []string{"pet", "v1", "getall", "limit", "offset"}, ""))
)
